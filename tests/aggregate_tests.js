...
Shower.registerRule("minAge", function(fieldValue, ruleValue){
...
Tinytest.add("aggregates tests", function (test) {
    ...
    var validationObject = Shower.aggregatesForm.validate([
    ...
    validationObject = Shower.aggregatesForm.validate([
        {"name": "int1", "value": "1"},
        {"name": "int2", "value": "1.5"},
        {"name": "int3", "value": "3.5"}
    ]);
